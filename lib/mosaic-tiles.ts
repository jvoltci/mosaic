...
export const TILES: Tile[] = [
  ...
  { slug: '/foundations/cpp-memory/move-semantics',    fallback: '/foundations/cpp-memory', title: 'Move Semantics',         summary: 'Rvalue references and the cost of a copy you didn\'t want.',     track: 'foundations', moduleName: 'C++ Memory', q: -8, r: -4, illustration: 'placeholder',   available: true },
  { slug: '/foundations/cpp-memory/smart-pointers',    fallback: '/foundations/cpp-memory', title: 'Smart Pointers & RAII',  summary: 'Ownership encoded in the type system.',                            track: 'foundations', moduleName: 'C++ Memory', q: -7, r: -4, illustration: 'placeholder',   available: true },
  { slug: '/foundations/cpp-memory/custom-allocators', fallback: '/foundations/cpp-memory', title: 'PyTorch Caching Allocator', summary: 'Skip the system allocator on hot ML paths.',                    track: 'foundations', moduleName: 'C++ Memory', q: -6, r: -4, illustration: 'placeholder',   available: true },
  // Module: Caches & Hardware Reality
  { slug: '/foundations/caches-and-architecture/cache-lines',          fallback: '/foundations/caches-and-architecture', title: 'Cache Lines',         summary: 'Spatial locality and the 64-byte unit of work.',          track: 'foundations', moduleName: 'Caches & HW', q: -9, r: -3, illustration: 'placeholder', available: true },
  { slug: '/foundations/caches-and-architecture/branch-prediction',    fallback: '/foundations/caches-and-architecture', title: 'Branch Prediction',   summary: 'Why an unpredictable if-statement can cost 20 cycles.',  track: 'foundations', moduleName: 'Caches & HW', q: -8, r: -3, illustration: 'placeholder', available: true },
  { slug: '/foundations/caches-and-architecture/numa-and-topology',    fallback: '/foundations/caches-and-architecture', title: 'NUMA & Topology',     summary: 'PCIe, NVLink, CXL — what hosts and GPUs cost to talk to.', track: 'foundations', moduleName: 'Caches & HW', q: -7, r: -3, illustration: 'placeholder', available: true },
  { slug: '/foundations/caches-and-architecture/profiling',            fallback: '/foundations/caches-and-architecture', title: 'Profiling Tools',     summary: 'perf, nsys, ncu, eBPF — see what the silicon is actually doing.', track: 'foundations', moduleName: 'Caches & HW', q: -6, r: -3, illustration: 'placeholder', available: true },
  // Module: Parallelism
  { slug: '/foundations/parallelism/threading',  fallback: '/foundations/parallelism', title: 'Threading',  summary: 'OS threads, the scheduler, and where they bite.',  track: 'foundations', moduleName: 'Parallelism', q: -8, r: -2, illustration: 'placeholder', available: true },
  { slug: '/foundations/parallelism/async',      fallback: '/foundations/parallelism', title: 'Async Runtimes', summary: 'Coroutines, executors, CUDA streams — concurrency without locks.', track: 'foundations', moduleName: 'Parallelism', q: -7, r: -2, illustration: 'placeholder', available: true },
  { slug: '/foundations/parallelism/simd',       fallback: '/foundations/parallelism', title: 'SIMD',       summary: 'AVX-512, ARM SVE2 — 8–16 floats per instruction.', track: 'foundations', moduleName: 'Parallelism', q: -6, r: -2, illustration: 'placeholder', available: true },
  ...
  // Module: Quantization
  { slug: '/ml-execution/quantization/fp8-overview',         fallback: '/ml-execution/quantization', title: 'FP8 Inference',         summary: 'E4M3 / E5M2 — the H100 format that replaced INT8.',          track: 'ml-execution', moduleName: 'Quantization', q: -4, r: -2, illustration: 'placeholder', available: true },
  { slug: '/ml-execution/quantization/int4-and-awq',         fallback: '/ml-execution/quantization', title: 'INT4 / AWQ / GPTQ',     summary: 'Two weights per byte — and the kernel that unpacks them fast.', track: 'ml-execution', moduleName: 'Quantization', q: -3, r: -2, illustration: 'placeholder', available: true },
  { slug: '/ml-execution/quantization/mxfp4-nvfp4',          fallback: '/ml-execution/quantization', title: 'MXFP4 / NVFP4',         summary: 'Block-floating-point microscaling on Blackwell.',             track: 'ml-execution', moduleName: 'Quantization', q: -2, r: -2, illustration: 'placeholder', available: true },
  { slug: '/ml-execution/quantization/rotation-quant',       fallback: '/ml-execution/quantization', title: 'Rotation Quantization', summary: 'QuaRot, SpinQuant — outlier suppression via Hadamard rotation.', track: 'ml-execution', moduleName: 'Quantization', q: -1, r: -2, illustration: 'placeholder', available: true },
  ...
  // Module: Distributed
  { slug: '/training/distributed/data-parallel',      fallback: '/training/distributed', title: 'Data Parallel & DDP',     summary: 'Ring-AllReduce, gradient bucketing, comm/compute overlap.',                track: 'training', moduleName: 'Distributed', q: 1, r: -3, illustration: 'placeholder', available: true },
  { slug: '/training/distributed/tensor-parallel',    fallback: '/training/distributed', title: 'Tensor Parallel',         summary: 'Megatron-LM column/row parallel and the two AllReduces.',                  track: 'training', moduleName: 'Distributed', q: 2, r: -3, illustration: 'placeholder', available: true },
  { slug: '/training/distributed/pipeline-parallel',  fallback: '/training/distributed', title: 'Pipeline & Zero-Bubble',  summary: 'GPipe, 1F1B, interleaved, and 2024 zero-bubble schedules.',                track: 'training', moduleName: 'Distributed', q: 3, r: -3, illustration: 'placeholder', available: true },
  ...
  { slug: '/training/post-training/sft',              fallback: '/training/post-training', title: 'SFT & Instruction Tune', summary: 'Chat templates, sample packing, prompt loss masking.',                    track: 'training', moduleName: 'Post-training', q: 1, r: -2, illustration: 'placeholder', available: true },
  ...
  { slug: '/training/post-training/dpo',              fallback: '/training/post-training', title: 'DPO / IPO / KTO',         summary: 'Preference optimization without RL — closed-form classification.',        track: 'training', moduleName: 'Post-training', q: 3, r: -2, illustration: 'placeholder', available: true },
  ...
  { slug: '/applied/llm-basics/structured-output',  fallback: '/applied/llm-basics', title: 'Structured Output',      summary: 'JSON mode, Pydantic, Outlines — guarantee valid output.',                 track: 'applied', moduleName: 'LLM Basics', q: 2, r: 1, illustration: 'placeholder', available: true },
  ...
  { slug: '/applied/llm-basics/embeddings',         fallback: '/applied/llm-basics', title: 'Embeddings',             summary: 'Dense vs sparse, contrastive training, Matryoshka truncation.',             track: 'applied', moduleName: 'LLM Basics', q: 4, r: 1, illustration: 'placeholder', available: true },
  // Module: RAG & Agents
  ...
  { slug: '/applied/rag-agents/react-agents',       fallback: '/applied/rag-agents', title: 'Build a ReAct Agent',    summary: 'Implement ReAct from scratch in 80 lines. Solve real tasks.',             track: 'applied', moduleName: 'RAG & Agents', q: 3, r: 2, illustration: 'placeholder', available: true },
  { slug: '/applied/rag-agents/mcp',                fallback: '/applied/rag-agents', title: 'Model Context Protocol', summary: 'Expose tools, resources, prompts to any LLM client. Build a server.',     track: 'applied', moduleName: 'RAG & Agents', q: 4, r: 2, illustration: 'placeholder', available: true },
  // Module: Serve & Ship
  ...
  { slug: '/applied/frontier/multimodal',           fallback: '/applied/frontier', title: 'Multimodal (Vision)',   summary: 'CLIP, SigLIP, VLMs — image search + chart QA in your browser.',           track: 'applied', moduleName: 'Frontier',    q: 1, r: 4, illustration: 'placeholder', available: true },
  { slug: '/applied/frontier/audio',                fallback: '/applied/frontier', title: 'Audio & Voice',         summary: 'Whisper + Claude + Kokoro — a voice agent end-to-end.',                    track: 'applied', moduleName: 'Frontier',    q: 2, r: 4, illustration: 'placeholder', available: true },
  { slug: '/applied/frontier/safety',               fallback: '/applied/frontier', title: 'Safety & Injection',    summary: 'Llama Guard, dual-LLM, spotlighting — defense-in-depth that actually works.', track: 'applied', moduleName: 'Frontier', q: 3, r: 4, illustration: 'placeholder', available: true },
  { slug: '/applied/frontier/capstone',             fallback: '/applied/frontier', title: 'Capstone: Ship It',     summary: 'Build, eval, and deploy a production RAG-agent in one weekend.',          track: 'applied', moduleName: 'Frontier',    q: 4, r: 4, illustration: 'placeholder', available: true },
