...
export const TILES: Tile[] = [
  ...
  { slug: '/ml-execution/tensors-in-memory/strides-and-layout', fallback: '/ml-execution/tensors-in-memory', title: 'Strides & Layout',  summary: 'A tensor isn\'t shape — it\'s shape + strides.',          track: 'ml-execution', moduleName: 'Tensors',   q: -4, r: -4, illustration: 'placeholder', available: false },
  { slug: '/ml-execution/tensors-in-memory/contiguous-vs-non',  fallback: '/ml-execution/tensors-in-memory', title: 'Contiguous vs Non',  summary: 'Why a transposed view is sometimes 10× slower.',           track: 'ml-execution', moduleName: 'Tensors',   q: -3, r: -4, illustration: 'placeholder', available: false },
  { slug: '/ml-execution/tensors-in-memory/tensor-library',     fallback: '/ml-execution/tensors-in-memory', title: 'Build a Tensor Lib', summary: 'The minimal tensor type from scratch in 200 lines of C++.',track: 'ml-execution', moduleName: 'Tensors',   q: -2, r: -4, illustration: 'placeholder', available: false },
  { slug: '/ml-execution/tensors-in-memory/tma-async-copy',     fallback: '/ml-execution/tensors-in-memory', title: 'TMA & cp.async',     summary: 'Hopper\'s producer-consumer warps and async memory pipelines.', track: 'ml-execution', moduleName: 'Tensors', q: -1, r: -4, illustration: 'placeholder', available: false },
  // Module: GPU & GEMM
  { slug: '/ml-execution/gpu-fundamentals/sm-architecture',  fallback: '/ml-execution/gpu-fundamentals', title: 'SM Architecture',     summary: 'SMs, warps, schedulers — how a GPU thinks.',                    track: 'ml-execution', moduleName: 'GPU & GEMM', q: -4, r: -3, illustration: 'placeholder', available: false },
  { slug: '/ml-execution/gpu-fundamentals/thread-hierarchy', fallback: '/ml-execution/gpu-fundamentals', title: 'Thread Hierarchy',    summary: 'Grids, blocks, threads — and why the hierarchy matters.',       track: 'ml-execution', moduleName: 'GPU & GEMM', q: -3, r: -3, illustration: 'placeholder', available: false },
  { slug: '/ml-execution/gpu-fundamentals/shared-memory',    fallback: '/ml-execution/gpu-fundamentals', title: 'Shared Memory',       summary: 'The fast scratch pad every fast kernel uses.',                  track: 'ml-execution', moduleName: 'GPU & GEMM', q: -2, r: -3, illustration: 'placeholder', available: false },
  ...
  { slug: '/training/optimization/lr-schedules',      fallback: '/training/optimization', title: 'LR Schedules & WSD',   summary: 'Warmup-Stable-Decay — why MiniCPM and DeepSeek-V3 swapped cosine.',          track: 'training', moduleName: 'Optimization', q: 3, r: -4, illustration: 'placeholder', available: false },
  ...
  // Module: Attention
  { slug: '/llm-architecture/attention/mha',             fallback: '/llm-architecture/attention', title: 'Multi-Head Attention',  summary: 'The original attention mechanism, head by head.',                    track: 'llm-architecture', moduleName: 'Attention', q: -9, r: 1, illustration: 'placeholder', available: false },
  ...
  { slug: '/llm-architecture/kv-cache/prefix-radix',     fallback: '/llm-architecture/kv-cache', title: 'Prefix & RadixAttention',  summary: 'SGLang\'s shared-prefix cache reuse across requests.',                  track: 'llm-architecture', moduleName: 'KV Cache', q: -7, r: 2, illustration: 'placeholder', available: false },
  { slug: '/llm-architecture/kv-cache/disaggregated',    fallback: '/llm-architecture/kv-cache', title: 'Disaggregated Serving',    summary: 'DistServe/Mooncake — split prefill from decode across GPUs.',           track: 'llm-architecture', moduleName: 'KV Cache', q: -6, r: 2, illustration: 'placeholder', available: false },
  // Module: Inference-Time
  { slug: '/llm-architecture/inference-time/sampling',              fallback: '/llm-architecture/inference-time', title: 'Sampling',              summary: 'Temperature, top-p, min-p — choosing the next token.',                track: 'llm-architecture', moduleName: 'Inference', q: -9, r: 3, illustration: 'placeholder', available: false },
  { slug: '/llm-architecture/inference-time/structured-output',     fallback: '/llm-architecture/inference-time', title: 'Structured Output',     summary: 'XGrammar, Outlines — constrained decoding via FSMs.',                  track: 'llm-architecture', moduleName: 'Inference', q: -8, r: 3, illustration: 'placeholder', available: false },
  { slug: '/llm-architecture/inference-time/chunked-prefill',       fallback: '/llm-architecture/inference-time', title: 'Chunked Prefill',       summary: 'The unified scheduling primitive vLLM v1 was rebuilt around.',         track: 'llm-architecture', moduleName: 'Inference', q: -7, r: 3, illustration: 'placeholder', available: false },
  ...
  // ════════════════════ ML COMPILERS (indigo) ════════════════════
  // Module: Foundation
  { slug: '/compilers/foundation/llvm-ir',          fallback: '/compilers/llvm', title: 'LLVM IR Tour',           summary: 'The universal intermediate representation.',                       track: 'compilers', moduleName: 'Foundation',  q: -4, r: 1, illustration: 'placeholder', available: false },
  { slug: '/compilers/foundation/passes',           fallback: '/compilers/llvm', title: 'Passes & Pipelines',     summary: 'How LLVM optimizations actually run.',                              track: 'compilers', moduleName: 'Foundation',  q: -3, r: 1, illustration: 'placeholder', available: false },
  { slug: '/compilers/foundation/mlir-overview',    fallback: '/compilers/llvm', title: 'MLIR Overview',          summary: 'Multi-level IR: linalg, gpu, llvm — pick the right vocabulary.',    track: 'compilers', moduleName: 'Foundation',  q: -2, r: 1, illustration: 'mlir',        available: false },
  { slug: '/compilers/foundation/lowering',         fallback: '/compilers/llvm', title: 'Dialects & Lowering',    summary: 'Walking the program down a level at a time, dialect by dialect.',  track: 'compilers', moduleName: 'Foundation',  q: -1, r: 1, illustration: 'placeholder', available: false },
  // Module: Production compilers
  { slug: '/compilers/tvm-and-xla/torch-compile',    fallback: '/compilers/tvm-and-xla', title: 'torch.compile',          summary: 'Dynamo + AOTAutograd + Inductor — the daily-driver compiler.',     track: 'compilers', moduleName: 'Production',  q: -4, r: 2, illustration: 'placeholder', available: true },
  { slug: '/compilers/production/jax-pallas',       fallback: '/compilers/tvm-and-xla', title: 'JAX & Pallas',           summary: 'StableHLO, XLA, and Pallas\' Triton-equivalent kernel DSL.',         track: 'compilers', moduleName: 'Production',  q: -3, r: 2, illustration: 'placeholder', available: false },
  { slug: '/compilers/production/iree-executorch',  fallback: '/compilers/tvm-and-xla', title: 'IREE & ExecuTorch',      summary: 'MLIR-based deployment compilers for edge and mobile.',              track: 'compilers', moduleName: 'Production',  q: -2, r: 2, illustration: 'placeholder', available: false },
  { slug: '/compilers/production/operator-fusion',  fallback: '/compilers/tvm-and-xla', title: 'Operator Fusion',        summary: 'Inductor\'s fusion heuristics; saving memory traffic.',              track: 'compilers', moduleName: 'Production',  q: -1, r: 2, illustration: 'placeholder', available: false },
  // Module: Kernel DSLs & Hardware
  { slug: '/compilers/kernels/triton',              fallback: '/compilers/gpu-kernels', title: 'Triton',                 summary: 'Block-programming for fast GPU kernels — no raw CUDA.',               track: 'compilers', moduleName: 'Kernels & HW', q: -4, r: 3, illustration: 'placeholder', available: false },
  { slug: '/compilers/kernels/cute-cutlass',        fallback: '/compilers/gpu-kernels', title: 'CuTe & CUTLASS 4',       summary: 'NVIDIA\'s tile-level layout language for Hopper/Blackwell.',           track: 'compilers', moduleName: 'Kernels & HW', q: -3, r: 3, illustration: 'placeholder', available: false },
  { slug: '/compilers/kernels/thunderkittens',      fallback: '/compilers/gpu-kernels', title: 'ThunderKittens & TileLang', summary: 'New tile DSLs from Stanford & friends — terser than Triton.',        track: 'compilers', moduleName: 'Kernels & HW', q: -2, r: 3, illustration: 'placeholder', available: false },
  { slug: '/compilers/kernels/hardware-landscape',  fallback: '/compilers/gpu-kernels', title: 'Hardware Landscape 2026', summary: 'Blackwell · MI355X · TPU v6 · Cerebras · Groq — what each is for.',  track: 'compilers', moduleName: 'Kernels & HW', q: -1, r: 3, illustration: 'placeholder', available: false },
  ...
  { slug: '/applied/serve/cost-latency',            fallback: '/applied/serve', title: 'Cost & Latency',          summary: 'Prompt caching, batching, model routing — get 5–10× cheaper.',           track: 'applied', moduleName: 'Serve & Ship', q: 3, r: 3, illustration: 'placeholder', available: false },
  { slug: '/applied/serve/observability',           fallback: '/applied/serve', title: 'Observability',           summary: 'Tracing, online evals, A/B with Langfuse. See what users actually do.',    track: 'applied', moduleName: 'Serve & Ship', q: 4, r: 3, illustration: 'placeholder', available: false },
