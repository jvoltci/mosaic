...
export const TILES: Tile[] = [
  ...
  { slug: '/compilers/production/jax-pallas',       fallback: '/compilers/production', title: 'JAX & Pallas',           summary: 'StableHLO, XLA, and Pallas\' Triton-equivalent kernel DSL.',         track: 'compilers', moduleName: 'Production',  q: -3, r: 2, illustration: 'placeholder', available: false },
  { slug: '/compilers/production/iree-executorch',  fallback: '/compilers/production', title: 'IREE & ExecuTorch',      summary: 'MLIR-based deployment compilers for edge and mobile.',              track: 'compilers', moduleName: 'Production',  q: -2, r: 2, illustration: 'placeholder', available: false },
  { slug: '/compilers/production/operator-fusion',  fallback: '/compilers/production', title: 'Operator Fusion',        summary: 'Inductor\'s fusion heuristics; saving memory traffic.',              track: 'compilers', moduleName: 'Production',  q: -1, r: 2, illustration: 'placeholder', available: false },
  // Module: Kernel DSLs & Hardware
  { slug: '/compilers/kernels/triton',              fallback: '/compilers/kernels', title: 'Triton',                 summary: 'Block-programming for fast GPU kernels — no raw CUDA.',               track: 'compilers', moduleName: 'Kernels & HW', q: -4, r: 3, illustration: 'placeholder', available: false },
  { slug: '/compilers/kernels/cute-cutlass',        fallback: '/compilers/kernels', title: 'CuTe & CUTLASS 4',       summary: 'NVIDIA\'s tile-level layout language for Hopper/Blackwell.',           track: 'compilers', moduleName: 'Kernels & HW', q: -3, r: 3, illustration: 'placeholder', available: false },
  { slug: '/compilers/kernels/thunderkittens',      fallback: '/compilers/kernels', title: 'ThunderKittens & TileLang', summary: 'New tile DSLs from Stanford & friends — terser than Triton.',        track: 'compilers', moduleName: 'Kernels & HW', q: -2, r: 3, illustration: 'placeholder', available: false },
  { slug: '/compilers/kernels/hardware-landscape',  fallback: '/compilers/kernels', title: 'Hardware Landscape 2026', summary: 'Blackwell · MI355X · TPU v6 · Cerebras · Groq — what each is for.',  track: 'compilers', moduleName: 'Kernels & HW', q: -1, r: 3, illustration: 'placeholder', available: false },
