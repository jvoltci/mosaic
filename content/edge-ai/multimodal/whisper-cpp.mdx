...
The decoder is GPT-2-shaped. Whisper.cpp's `ggml` runtime treats it identically to a Llama decode — same <Term name="kv cache">KV cache</Term>, same speculative-decoding tricks apply (you can speculative-decode Whisper-large with Distil-Whisper as the draft model).
