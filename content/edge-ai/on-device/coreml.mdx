...
<FillIn
  ...
  explanation="The ANE is Apple's NPU. ~35 TOPS on A17/M3, ~38 TOPS on M4. (Apple's '100+ TOPS' number is full-SoC aggregate, not ANE silicon.) Optimized for FP16 matmul and conv; the 2024+ generation added strong support for transformer patterns and palettized weights."
/>
