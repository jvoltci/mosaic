...
Two terms: cross-entropy on hard labels, KL on the teacher's soft targets. The temperature `T` flattens both distributions so you transfer information from the teacher's "second-best guesses" too.
