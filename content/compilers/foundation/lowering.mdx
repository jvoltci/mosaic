...
The most important specific lowering in AI compilers: <Term name="bufferization">**bufferization**</Term> turns value-typed tensors (immutable, no concrete memory) into memory-typed `memref`s (concrete buffers).
