...
ThunderKittens posted FA-2 forward at >770 TF/s on H100 in 2024 — at the time, faster than the official FA-2 CUDA implementation, in 80 lines of C++. That's the "wow" benchmark people remember.
...
<Resources
  items={[
    ...
    { kind: 'repo', href: 'https://github.com/HazyResearch/ThunderKittens', title: 'HazyResearch/ThunderKittens', note: 'Reference. The `kernels/attn/` directory has the FA-2 + FA-3 implementations in <100 lines each.' },
