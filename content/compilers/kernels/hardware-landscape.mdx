...
**Where it doesn't fit:** the kernel DSL story is Cerebras-proprietary; you're learning their stack from scratch. Frontier-scale (>100B params) doesn't fit on-chip.
...
1. **Training a frontier-scale model (>100B params)?** B200/GB200 (NVL72 cluster) or TPU v6 pod. Frontier labs use both.
