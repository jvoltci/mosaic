...
<Resources
  items={[
    ...
    { kind: 'paper', href: 'https://arxiv.org/abs/2407.08447', title: 'FlashAttention-3: Fast and Accurate Attention with Asynchrony and Low-precision', author: 'Shah et al., 2024', note: 'The CUTLASS-based FA-3. Section 4 explains the warp-specialized pingpong schedule that CUTLASS 4 ships as a template.' },
