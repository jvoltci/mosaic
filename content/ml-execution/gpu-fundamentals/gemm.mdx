...
<Resources
  items={[
    ...
    { kind: 'paper', href: 'https://arxiv.org/abs/2410.20399', title: 'ThunderKittens: Simple, Fast, and Adorable AI Kernels', author: 'Spector et al. (Hazy Research, 2024)', note: 'Tile-DSL alternative to CUTLASS — terse, expressive, hits the same peak.' },
