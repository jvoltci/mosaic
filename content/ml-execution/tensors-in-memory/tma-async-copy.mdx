...
<Resources
  items={[
    ...
    { kind: 'paper', href: 'https://arxiv.org/abs/2407.08447', title: 'FlashAttention-3', author: 'Shah et al., 2024', note: 'Section 4.2: warp-specialized + multi-stage TMA on Hopper. The reference application of the technique.' },
