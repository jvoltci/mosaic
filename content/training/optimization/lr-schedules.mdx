...
| MiniCPM 2.4B | WSD | 2000 steps | 90% stable / 10% decay | 1e-2 | 1T |
...
<Resources
  items={[
    ...
    { kind: 'paper', href: 'https://arxiv.org/abs/2407.10671', title: 'Scaling Law with Learning Rate Annealing', author: 'Hägele et al. (2024)', note: 'Rigorous analysis of how cooldown phases affect scaling law predictions. The theory behind why WSD works.' },
