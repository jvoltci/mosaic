...
<Term name="wsd">WSD</Term> — Warmup-Stable-Decay — broke that constraint in 2024. Train at peak LR for as long as you want; trigger a short cooldown when you decide to stop. DeepSeek-V3 ran 14.3 trillion tokens at constant LR before deciding it was time to settle. MiniCPM, Qwen 2.5, and most 2025 frontier runs use the same pattern. This lesson is the three schedules you'll actually see and how to pick.
