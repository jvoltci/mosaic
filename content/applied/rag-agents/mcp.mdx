...
The client mediates; the server implements; the LLM uses. Same <Term name="react">ReAct</Term> loop, standardized handshake.
...
def get_settings() -> str:
    ...
    return '{"theme": "dark", "model": "claude-sonnet-4-5"}'
