...
<ColabLink
  href="https://colab.research.google.com/github/your-github/mosaic-notebooks/blob/main/tool-use.ipynb"
  description="Same agent against Claude 3.5 Sonnet, GPT-4o, and a local Llama-3.1-8B-Instruct via transformers. Compare correctness + parallel-call behavior."
/>
