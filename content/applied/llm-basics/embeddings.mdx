...
|--------------------|---------|---------|------------------------------------------|
| **Nomic Embed v2** | 768     | ~67     | Open, fast, Matryoshka                   |
| **BGE-M3**         | 1024    | ~69     | Multi-functional (dense + sparse + colbert) |
| **GTE-Qwen2-7B**   | 3584    | ~72     | Highest quality; 7B params, slower       |
| **Stella-1.5B**    | 1536    | ~71     | Strong open with reasonable size         |
| Voyage 3 (proprietary) | 1024 | ~70     | Production API; best ergonomics          |
| OpenAI text-embedding-3-large | 3072 | ~67 | Default cloud option                  |

**For most products: Nomic Embed v2** — small, fast, near-top quality, Matryoshka, MIT-licensed. Upgrade to BGE-M3 if multilingual; GTE-Qwen2 if you need every last MTEB point and can afford the compute.
